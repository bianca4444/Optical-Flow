...
typedef struct {
    ...
    XLucas_kanade_hls_uio_map maps[ MAX_UIO_MAPS ];
} XLucas_kanade_hls_uio_info;

/***************** Variable Definitions **************************************/
static XLucas_kanade_hls_uio_info uio_info;
...
static int uio_info_read_name(XLucas_kanade_hls_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XLucas_kanade_hls_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XLucas_kanade_hls_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XLucas_kanade_hls_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XLucas_kanade_hls_Initialize(XLucas_kanade_hls *InstancePtr, const char* InstanceName) {
	XLucas_kanade_hls_uio_info *InfoPtr = &uio_info;
