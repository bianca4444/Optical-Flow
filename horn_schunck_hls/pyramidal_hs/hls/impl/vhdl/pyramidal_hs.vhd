...
architecture behav of pyramidal_hs is 
    ...
    "pyramidal_hs_pyramidal_hs,hls_ip_2025_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7k70t-fbg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=28.952482,HLS_SYN_LAT=1412689,HLS_SYN_TPT=none,HLS_SYN_MEM=42,HLS_SYN_DSP=0,HLS_SYN_FF=29943,HLS_SYN_LUT=32560,HLS_VERSION=2025_2}";
