set moduleName horn_schunck_64_Pipeline_VITIS_LOOP_33_5
set isTopModule 0
...
set cdfgNum 23
set C_modelName {horn_schunck_64_Pipeline_VITIS_LOOP_33_5}
...
set C_modelArgList {
	...
	{ y int 6 regular  }
	{ add_ln37 int 6 regular  }
	{ u int 16 regular {array 4096 { 1 2 } 1 1 }  }
	{ add_ln37_1 int 6 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "u_load", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "add_ln37", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "u", "interface" : "memory", "bitwidth" : 16, "direction" : "READWRITE"} , 
 	{ "Name" : "add_ln37_1", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ y sc_in sc_lv 6 signal 2 } 
	{ add_ln37 sc_in sc_lv 6 signal 3 } 
	{ u_address0 sc_out sc_lv 12 signal 4 } 
	{ u_ce0 sc_out sc_logic 1 signal 4 } 
	{ u_q0 sc_in sc_lv 16 signal 4 } 
	{ u_address1 sc_out sc_lv 12 signal 4 } 
	{ u_ce1 sc_out sc_logic 1 signal 4 } 
	{ u_we1 sc_out sc_logic 1 signal 4 } 
	{ u_d1 sc_out sc_lv 16 signal 4 } 
	{ u_q1 sc_in sc_lv 16 signal 4 } 
	{ add_ln37_1 sc_in sc_lv 6 signal 5 } 
	{ v_address0 sc_out sc_lv 12 signal 6 } 
	{ v_ce0 sc_out sc_logic 1 signal 6 } 
	{ v_q0 sc_in sc_lv 16 signal 6 } 
	{ v_address1 sc_out sc_lv 12 signal 6 } 
	{ v_ce1 sc_out sc_logic 1 signal 6 } 
	{ v_we1 sc_out sc_logic 1 signal 6 } 
	{ v_d1 sc_out sc_lv 16 signal 6 } 
	{ v_q1 sc_in sc_lv 16 signal 6 } 
	{ Ix64_address0 sc_out sc_lv 12 signal 7 } 
	{ Ix64_ce0 sc_out sc_logic 1 signal 7 } 
	{ Ix64_q0 sc_in sc_lv 16 signal 7 } 
	{ Iy64_address0 sc_out sc_lv 12 signal 8 } 
	{ Iy64_ce0 sc_out sc_logic 1 signal 8 } 
	{ Iy64_q0 sc_in sc_lv 16 signal 8 } 
	{ It64_address0 sc_out sc_lv 12 signal 9 } 
	{ It64_ce0 sc_out sc_logic 1 signal 9 } 
	{ It64_q0 sc_in sc_lv 16 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "add_ln37", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "add_ln37", "role": "default" }} , 
 	...
 	{ "name": "add_ln37_1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "add_ln37_1", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3479", "Max" : "3479"}
	, {"Name" : "Interval", "Min" : "3478", "Max" : "3478"}
]}
...
set Spec2ImplPortList { 
	...
	add_ln37 { ap_none {  { add_ln37 in_data 0 6 } } }
	...
	add_ln37_1 { ap_none {  { add_ln37_1 in_data 0 6 } } }
